...
function CompleteRegisterForm(props) {
  const { firstName, lastName, email, phone, gender } = props?.data;
  ...
  const formik = useFormik({
    ...
    onSubmit: async () => {
      ...
      const response = APIService.update('/auth/complete', '', payload);
